...
void _vunglePlayAdWithOptions( BOOL showCloseButton, BOOL incentivized, int orientation, const char * user )
{
	...
	[options setObject:@(showCloseButton) forKey:VunglePlayAdOptionKeyShowClose];
